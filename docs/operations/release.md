...
- Reads the shared production Flux Connect relay URL and Clerk client configuration before packaging clients.
...
10. Complete the Clerk Native API and AASA setup in [Flux Connect Clerk Setup](../internals/t3-connect.md#desktop-passkeys).
