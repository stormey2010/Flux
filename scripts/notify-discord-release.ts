  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Flux prerelease is available for nightly testers."
          : "A new Flux release is available.",
...
).pipe(Command.withDescription("Post a Flux release announcement to Discord."));
