...
/**
 * The skew a user can act on: the connected server runs an older Flux than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same Flux version.",
  };
}
