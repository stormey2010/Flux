    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={isConfirming}>
        <DialogHeader>
          ...
          <DialogDescription>
            {isInstalling
              ? "Flux is preparing this environment for secure access through Flux Connect."
              : "Flux needs the relay client to make this environment available through Flux Connect."}
          </DialogDescription>
        </DialogHeader>
          ...
          {isInstalling ? (
            <div className="space-y-2.5">
              ...
              <p className="text-xs leading-relaxed text-muted-foreground">
                Keep Flux open while the relay client is installed.
              </p>
            </div>
          ) : (
            <div className="rounded-xl border border-border/70 bg-muted/35 p-3">
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                Flux will download and install version{" "}
