...
/**
 * Post-sign-in onboarding wizard for Flux Connect. Opens on every in-session
 ...
 * account's Flux Connect environments so every device can be connected right
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up Flux Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Flux Connect."
