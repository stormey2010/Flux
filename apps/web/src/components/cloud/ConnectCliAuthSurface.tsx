...
const invalidLinkMessage = {
  ...
  description:
    "The link is missing its authorization request. Re-run the Flux connect command in your terminal and open the freshly printed URL.",
} as const;
  ...
  return (
    <AuthSurfaceShell>
      <ConnectCliAuthMessage
        ...
        description={
          isSignedIn
            ? "Redirecting to authorize Flux Connect for your CLI…"
            : "Sign in to continue authorizing Flux Connect for your CLI."
        }
      />
      {isLoaded && !isSignedIn ? (
        <div className="mt-6">
    ...
    return (
      <AuthSurfaceShell>
        <ConnectCliAuthMessage
          ...
          description="No authorization code was returned. Re-run the Flux connect command in your terminal and try again."
        />
      </AuthSurfaceShell>
    );
  }
    ...
    return (
      <AuthSurfaceShell>
        <ConnectCliAuthMessage
          ...
          description="This authorization response does not match a connect request started in this browser. Re-run the Flux connect command in your terminal and open the freshly printed URL in this browser."
        />
      </AuthSurfaceShell>
    );
  }
  ...
  return (
    <AuthSurfaceShell>
      ...
      <p className="mt-6 text-xs leading-relaxed text-muted-foreground">
        ...
        their machine to your Flux Connect account while it is valid.
      </p>
    </AuthSurfaceShell>
  );
}
