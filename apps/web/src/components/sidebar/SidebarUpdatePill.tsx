...
function resolveSidebarUpdatePresentation({
  action,
  hasMainBuildAvailable,
  isDownloading,
  showCheckIcon,
}: {
  readonly action: ReturnType<typeof resolveDesktopUpdateButtonAction>;
  readonly hasMainBuildAvailable: boolean;
  readonly isDownloading: boolean;
  readonly showCheckIcon: boolean;
}) {
  const showUpdateDetails = action !== "none" || hasMainBuildAvailable || isDownloading;
...
function SidebarUpdateControl() {
  ...
  const isMainBuildAvailable = hasNewerMainCommit(state);
  ...
  const { iconStatus, showUpdateDetails, showUpdateIconState } = resolveSidebarUpdatePresentation({
    action,
    isDownloading,
    hasMainBuildAvailable: isMainBuildAvailable,
    showCheckIcon,
  });
