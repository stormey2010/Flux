...
export const ProviderModelPicker = memo(function ProviderModelPicker(props: {
  ...
  const triggerTitle = props.isDefaultAgentSelected
    ? (props.selectedAgentName ?? "Default agent")
    : selectedModel
      ? getTriggerDisplayModelName(selectedModel)
      : props.model;
  const triggerLabel = props.isDefaultAgentSelected
    ? props.selectedAgentName
      ? `Agent · ${props.selectedAgentName}`
      : props.coordinatorModel
        ? `Coordinator · ${props.coordinatorModel.instanceId} · ${props.coordinatorModel.model}`
        : "Coordinator · uses the chat model"
    : selectedModel
    ...
    >
      ...
      >
        <ModelPickerContent
          ...
          {...(props.isDefaultAgentSelected !== undefined
            ? { isDefaultAgentSelected: props.isDefaultAgentSelected }
            : {})}
          {...(props.coordinatorModel !== undefined
            ? { coordinatorModel: props.coordinatorModel }
            : {})}
          onDefaultAgentSelect={() => {
            if (props.disabled) return;
            props.onDefaultAgentSelect?.();
            setIsMenuOpen(false);
          }}
