    ...
    <Empty className="min-h-64 gap-4 border-t px-6 py-10 md:p-10">
      ...
      <EmptyHeader>
        ...
        <EmptyDescription className="text-[0.8125rem] leading-[1.125rem]">
          Sign in to Flux on your iPhone to register it for push notifications and Live Activities.
        </EmptyDescription>
      </EmptyHeader>
    </Empty>
  );
...
export function MobileClientsUserProfilePage() {
  ...
  return (
    <ClerkUserProfilePage
      ...
      description="Devices registered to receive Flux Connect activity from your environments."
      action={
        <ClerkUserProfileRefreshButton
