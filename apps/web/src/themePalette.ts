...
export const T3_CHAT_THEME_LABEL = "Flux";
...
// Earlier builds shipped every maintainer theme under a legacy prefix; the
// flagship palette remains readable. Stored preferences and mixes with the
...
// Older builds stored the dark Flux palette as a separate theme. Keep
...
/**
 * The palette Flux wears with no theme installed, captured from the app's
...
/**
 * The standard Flux look as a theme palette, for seeding a new theme when
 * no theme is installed. Distinct from {@link getDefaultThemeColors}, which
 * carries the flagship Flux palette used to fill roles omitted by theme
 * files.
 */
...
/**
 * The status colors Flux shows without a theme, read from the app's own
