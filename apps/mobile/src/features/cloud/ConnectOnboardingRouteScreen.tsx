...
/**
 * Post-sign-in onboarding sheet for Flux Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's Flux Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your Flux account to set up Flux Connect.
            </Text>
          </View>
        )}
