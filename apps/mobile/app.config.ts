...
const VARIANT_CONFIG = {
  development: {
    appName: "Flux Dev",
    scheme: "flux-dev",
    iosBundleIdentifier: "app.flux.mobile.dev",
    androidPackage: "app.flux.mobile.dev",
    relyingParty: "clerk.t3.codes",
    assets: DEVELOPMENT_ASSETS,
  },
  preview: {
    appName: "Flux Preview",
    scheme: "flux-preview",
    iosBundleIdentifier: "app.flux.mobile.preview",
    androidPackage: "app.flux.mobile.preview",
    relyingParty: "clerk.t3.codes",
  ...
  production: {
    appName: "Flux",
    scheme: "flux",
    iosBundleIdentifier: "app.flux.mobile",
    androidPackage: "app.flux.mobile",
    relyingParty: "clerk.t3.codes",
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Flux agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Flux to connect to Flux servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Flux to access your camera so you can scan pairing QR codes.",
