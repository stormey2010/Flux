...
import Migration0044 from "./Migrations/044_ProjectionThreadMessagesChannel.ts";
import Migration0045 from "./Migrations/045_ProjectionThreadTurnQueue.ts";
import Migration0046 from "./Migrations/046_ProjectionThreadTurnQueueOrder.ts";
...
export const migrationEntries = [
  ...
  [44, "ProjectionThreadMessagesChannel", Migration0044],
  [45, "ProjectionThreadTurnQueue", Migration0045],
  [46, "ProjectionThreadTurnQueueOrder", Migration0046],
] as const;
