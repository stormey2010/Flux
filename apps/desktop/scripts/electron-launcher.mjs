// This file mostly exists because we want dev mode to use the Flux identity instead of "electron".
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Flux (Dev)" : "Flux";
export const APP_BUNDLE_ID = isDevelopment
  ? `app.flux.desktop.dev.${devBundleIdSuffix || "local"}`
  : "app.flux.desktop";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["flux-dev"] : ["flux"];
