...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/Flux.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/Flux.app/Contents/Resources",
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["Flux (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "Flux (Alpha)");
