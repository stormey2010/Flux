...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "flux-dev" : "flux";
  // Reuse the prior installation's data directory so a Flux upgrade keeps projects and settings.
  const legacyUserDataDirName = isDevelopment ? "t3" + "code-dev" : "t3" + "code";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "app.flux.desktop.dev" : "app.flux.desktop",
    ),
    linuxDesktopEntryName: isDevelopment ? "flux-dev.desktop" : "flux.desktop",
    linuxWmClass: isDevelopment ? "flux-dev" : "flux",
