...
export const UPDATE_SET_ALPHA_CHANNEL = "desktop:update-set-alpha";
...
export const GET_CLOUDFLARE_TUNNEL_STATE_CHANNEL = "desktop:get-cloudflare-tunnel-state";
export const START_CLOUDFLARE_QUICK_TUNNEL_CHANNEL = "desktop:start-cloudflare-quick-tunnel";
export const STOP_CLOUDFLARE_QUICK_TUNNEL_CHANNEL = "desktop:stop-cloudflare-quick-tunnel";
export const CREATE_CLOUDFLARE_TUNNEL_CHANNEL = "desktop:create-cloudflare-tunnel";
export const CONNECT_CLOUDFLARE_CHANNEL = "desktop:connect-cloudflare";
export const DISCONNECT_CLOUDFLARE_CHANNEL = "desktop:disconnect-cloudflare";
export const DELETE_CLOUDFLARE_TUNNEL_CHANNEL = "desktop:delete-cloudflare-tunnel";
