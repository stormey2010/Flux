...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  getCloudflareTunnelState: () =>
    ipcRenderer.invoke(IpcChannels.GET_CLOUDFLARE_TUNNEL_STATE_CHANNEL),
  startCloudflareQuickTunnel: () =>
    ipcRenderer.invoke(IpcChannels.START_CLOUDFLARE_QUICK_TUNNEL_CHANNEL),
  stopCloudflareQuickTunnel: () =>
    ipcRenderer.invoke(IpcChannels.STOP_CLOUDFLARE_QUICK_TUNNEL_CHANNEL),
  createCloudflareTunnel: (input) =>
    ipcRenderer.invoke(IpcChannels.CREATE_CLOUDFLARE_TUNNEL_CHANNEL, input ?? null),
  connectCloudflare: () => ipcRenderer.invoke(IpcChannels.CONNECT_CLOUDFLARE_CHANNEL),
  disconnectCloudflare: () => ipcRenderer.invoke(IpcChannels.DISCONNECT_CLOUDFLARE_CHANNEL),
  deleteCloudflareTunnel: () => ipcRenderer.invoke(IpcChannels.DELETE_CLOUDFLARE_TUNNEL_CHANNEL),
  ...
  setAlphaUpdates: (enabled) => ipcRenderer.invoke(IpcChannels.UPDATE_SET_ALPHA_CHANNEL, enabled),
