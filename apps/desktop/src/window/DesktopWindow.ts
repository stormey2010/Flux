...
// The main renderer is the trusted Code UI. Keep its permission surface
// explicit while allowing browser speech recognition to access the microphone
// in the packaged Electron app (normal browsers prompt for this automatically).
