...
export interface DesktopUpdateState {
  ...
  mainCommitMessage?: string | null;
  mainCommitDate?: string | null;
}
...
export const DesktopUpdateStateSchema = Schema.Struct({
  ...
  mainCommitDate: Schema.optional(Schema.NullOr(Schema.String)),
});
...
export type DesktopCloudflareTunnelStatus =
  | "idle"
  | "authenticating"
  | "starting"
  | "running"
...
export const DesktopCloudflareTunnelStatusSchema = Schema.Literals([
  "idle",
  "authenticating",
  "starting",
  "running",
...
export interface DesktopCloudflareTunnelState {
  status: DesktopCloudflareTunnelStatus;
  localHttpUrl: string | null;
  publicUrl: string | null;
  hostname: string | null;
  error: string | null;
  cloudflareConnected?: boolean;
  cloudflareAccounts?: ReadonlyArray<{ id: string; name: string }>;
  cloudflareZones?: ReadonlyArray<{ id: string; name: string }>;
  cloudflareAccountId?: string | null;
  cloudflareZoneId?: string | null;
  tunnelId?: string | null;
}

export interface DesktopCloudflareTunnelCreateInput {
  accountId?: string;
  zoneId?: string;
  hostname?: string;
}

export const DesktopCloudflareTunnelCreateInputSchema = Schema.Struct({
...
export const DesktopCloudflareTunnelStateSchema = Schema.Struct({
  status: DesktopCloudflareTunnelStatusSchema,
  localHttpUrl: Schema.NullOr(Schema.String),
  publicUrl: Schema.NullOr(Schema.String),
  hostname: Schema.NullOr(Schema.String),
  error: Schema.NullOr(Schema.String),
  cloudflareConnected: Schema.optionalKey(Schema.Boolean),
  cloudflareAccounts: Schema.optionalKey(
    Schema.Array(Schema.Struct({ id: Schema.String, name: Schema.String })),
  ),
  cloudflareZones: Schema.optionalKey(
    Schema.Array(Schema.Struct({ id: Schema.String, name: Schema.String })),
  ),
  cloudflareAccountId: Schema.optionalKey(Schema.NullOr(Schema.String)),
  cloudflareZoneId: Schema.optionalKey(Schema.NullOr(Schema.String)),
  tunnelId: Schema.optionalKey(Schema.NullOr(Schema.String)),
});
...
export interface DesktopBridge {
  ...
  getCloudflareTunnelState?: () => Promise<DesktopCloudflareTunnelState>;
  /** Start a temporary TryCloudflare tunnel for the local Flux web app. */
  startCloudflareQuickTunnel?: () => Promise<DesktopCloudflareTunnelState>;
  /** Stop the temporary TryCloudflare tunnel, if one is running. */
  stopCloudflareQuickTunnel?: () => Promise<DesktopCloudflareTunnelState>;
  /** Start a managed Cloudflare tunnel after browser authentication. */
  createCloudflareTunnel?: (
    input?: DesktopCloudflareTunnelCreateInput,
  ) => Promise<DesktopCloudflareTunnelState>;
  connectCloudflare?: () => Promise<DesktopCloudflareTunnelState>;
  disconnectCloudflare?: () => Promise<DesktopCloudflareTunnelState>;
  deleteCloudflareTunnel?: () => Promise<DesktopCloudflareTunnelState>;
