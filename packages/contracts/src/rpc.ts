...
import { UsageQuotaSummary, UsageReadError, UsageSummary, UsageSummaryInput } from "./usage.ts";
...
export const WS_METHODS = {
  ...
  serverGetUsageQuota: "server.getUsageQuota",
...
export const WsServerGetUsageQuotaRpc = Rpc.make(WS_METHODS.serverGetUsageQuota, {
  payload: Schema.Struct({}),
  success: UsageQuotaSummary,
  error: EnvironmentAuthorizationError,
});
